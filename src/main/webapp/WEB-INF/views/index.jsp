...
<body>
    ...
    <section id="hero" class="text-center py-5 bg-light">
        <div class="container">
            ...
            <p>Book your vehicle servicing, repairs, and inspections with ease.</p>
    ...
    <section id="about" class="py-5 bg-light">
        <div class="container">
            ...
            <p class="text-center">E-Garage is dedicated to providing top-quality vehicle maintenance and repair services. Our expert mechanics ensure your vehicle is always in top condition.</p>
        </div>
    </section>
